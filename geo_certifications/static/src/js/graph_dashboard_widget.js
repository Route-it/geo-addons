odoo.define('plant_dashboard', function (require) {
'use strict';

var kanban_widgets = require('web_kanban.widgets');

var DashboardGraph = kanban_widgets.AbstractField.extend({
    start: function() {
...
kanban_widgets.registry.add('dashboard_graph', DashboardGraph);
